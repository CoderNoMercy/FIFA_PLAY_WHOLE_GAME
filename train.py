...
num_actions = 17  # [ shoot_low, shoot_high, left_arrow, right_arrow]
...
def save_model(model, num_epoch):
    if not os.path.exists("model_zheyu"):
        os.makedirs("model_zheyu")
    torch.save(model.state_dict(), "model_zheyu/model_{}iter.pth".format(num_epoch))
